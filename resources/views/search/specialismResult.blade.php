...
@section('main')
    ...
    <div class="first-section" id="wrapper" onload="address_geocoder()">
        <div class="row">
                ...
                <div class="col-md-12" id="contentfix">
                    <form method="get" action="#">
                        <div class="form-group">
                            ...
                            <input type="text" name="q" id="q" list="disciplines" class="form-control"
                                   value="{{$keyword}}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="filter_zip" id="filter_zip" class="form-control"
                                   onblur="address_geocoder()" value="{{$filter_zip}}">
                        </div>
                        <div class="form-group">
                            <label for="filter_city" class="control-label"><i>Plaats</i></label>
                            <input type="text" name="filter_city" id="filter_city" class="form-control"
                                   onblur="address_geocoder();" value="{{$filter_city}}">
                        </div>
                        ...
                        <div class="form-group" id="locationsearch">
                            ...
                            <input name="radius" id="radius" type="range" value="{{$radius}}" step="1" min="1" max="200"
                                   oninput=" redrawCircle(); distance.value = radius.value+' km'">
                                        ...
                                        @else
                                            <div class="col-md-4 spec" data-href="/specialist/{{$spec->url_name}}">
                                                <div class="box">
                                                    <div class="col-md-4">
                                                        <img alt="{{$spec->name}}"
                                                             src="{{urldecode(asset('images/avatars/specialists/'.$spec->profile_image)) }}"
                                                             class="spec_image">
                                                    </div>
                                                    <div class="col-md-8 " id="specinfo">
                                                        <p class="text-center">{{$spec->name}}</p>
                                                        ...
                                                        @endphp
                                                        <p class="text-center"
                                                           style="color: royalblue">@if($specialism){{$specialism->name}}@else
                                                                Geen werkgebied bekend @endif</p>
                                                        <p class="text-center">{{$spec->address}}</p>
                                                        <p class="text-center">{{$spec->postal_code}} {{$spec->city}}</p>
                                                        <p class="text-center">{{$spec->mobile_phone}}</p>
                                                    </div>
