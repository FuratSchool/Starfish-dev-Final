        ...
        <div class="card ">
            ...
            <div class="card-body">
                <form class="form-horizontal " role="form" method="POST"
                      action="{{ route('admin.wellness.update', $wellness) }}"
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error has-feedback' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <input id="name" type="text" pattern="^[a-zA-Z\s\-]+$" class="form-control"
                                           name="name"
                                           value="{{$wellness->name}}" placeholder="Naam" autofocus>
                            ...
                            <div class="form-group{{ $errors->has('description') ? ' has-error has-feedback' : '' }}">
                                ...
                                <div class="col-md-8">
                                 <textarea id="description" class="form-control" name="description"
                                           rows="10">{{$wellness->description}}</textarea>
                            ...
                            <div class="form-group{{ $errors->has('short_description') ? ' has-error has-feedback' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <input id="short_description" type="text" class="form-control"
                                           ...
                                           value="{{$wellness->short_description}}" placeholder="Korte Beschrijving"
                                           autofocus>
