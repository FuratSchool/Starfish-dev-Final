...
@section('main')
    <div class="col-md-6 cbox-fluid">
        <div class="btitle">Nieuwe Therapie</div>
        <hr class="bdivider">
        <div class="bcontent">
            <form class="form-horizontal " role="form" method="POST" action="{{ route('admin.therapies.store') }}" enctype="multipart/form-data" id="newspec">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group{{ $errors->has('short_description') ? ' has-error has-feedback' : '' }}">
                            ...
                            <div class="col-md-8">
                                ...
                                <p class="help-block">Geef in 1 a 2 zinnen weer wat dit therapie is</p>
