...
/////// Cropper Options set
    ...
    var options = {
        ...
        crop: function(e) {
            $("#article_image_cropped").val(parseInt(e.detail.width) + "," + parseInt(e.detail.height) + "," + parseInt(e.detail.x) + "," + parseInt(e.detail.y) + "," + parseInt(e.detail.rotate));
        }
    };
...
///// Saving Image with Ajax Call
    $("body").on("click", "#Save", function() {
        var form_data = $('#newarticle')[0];
        $.ajax({
            url: "/admin/artikelen/nieuw/artikelafbeelding", // Url to which the request is send
            type: "POST",
            ...
            {
                $('#article_image_filename').val(filename);
