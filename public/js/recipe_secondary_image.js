...
/////// Cropper Options set
    ...
    var options = {
        ...
        maxCropBoxWidth: 900,
        maxCropBoxHeight: 900,
        rotatable: true,
        cropBoxResizable: true,
        crop: function(e) {
            $("#secondary_image_cropped").val(parseInt(e.detail.width) + "," + parseInt(e.detail.height) + "," + parseInt(e.detail.x) + "," + parseInt(e.detail.y) + "," + parseInt(e.detail.rotate));
        }
    };
...
///// Saving Image with Ajax Call
    $("body").on("click", "#Save", function() {
        var form_data = $('#newrecipeSecondary')[0];
        $.ajax({
            url: "/admin/recepten/nieuw/secondaryimage", // Url to which the request is send
            type: "POST",
            ...
            {
                $('#secondary_image_filename').val(filename);
...
////// When user upload image
    $(document).on("change", "#secondary_image", function() {
